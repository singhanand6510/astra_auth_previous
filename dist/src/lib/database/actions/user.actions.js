    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, connectToAstraDb()];
                case 1:
                    _a.sent();
...
// UPDATE
export function updateUser(clerkId, user) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, User.findOneAndUpdate({ clerkId: clerkId }, user, {
                            new: true,
                        })];
                case 2:
                    updatedUser = _a.sent();
...
// DELETE
export function deleteUser(clerkId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, User.findOne({ clerkId: clerkId })];
                case 2:
                    userToDelete = _a.sent();
                    if (!userToDelete) {
                        throw new Error("User not found");
                    }
                    return [4 /*yield*/, User.findByIdAndDelete(userToDelete._id)];
                case 3:
                    deletedUser = _a.sent();
                    revalidatePath("/");
...
// USE CREDITS
export function updateCredits(userId, creditFee) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, User.findOneAndUpdate({ _id: userId }, { $inc: { creditBalance: creditFee } }, { new: true })];
                case 2:
